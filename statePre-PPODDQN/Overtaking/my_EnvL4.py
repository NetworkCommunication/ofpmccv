...
config_path = "data/Lane4/StraightRoad.sumocfg"
...
class LaneChangePredict(gym.Env):
    ...
    def reset(self):
        ...
        sumo_binary = "sumo"
        sumocfg_file = "data/Lane4/StraightRoad.sumocfg"
    ...
    def updateReward(self, action, state):
        ...
        if isOC != 1:
            ...
            df.to_csv('result/normal/numberOfLaneChanges.csv', index=False, mode='a', header=False)
