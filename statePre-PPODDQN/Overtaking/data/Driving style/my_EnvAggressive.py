...
config_path = "aggressive/StraightRoad.sumocfg"
...
class LaneChangePredict(gym.Env):
    ...
    def reset(self):
        ...
        sumo_binary = "sumo"
        sumocfg_file = "aggressive/StraightRoad.sumocfg"
    ...
    def updateReward(self, action, state):
        ...
        if isOC != 1:
            ...
            df.to_csv('result/aggressive/numberOfLaneChanges.csv', index=False, mode='a', header=False)
