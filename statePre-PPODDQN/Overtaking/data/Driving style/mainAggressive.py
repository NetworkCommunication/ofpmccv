...
from my_EnvAggressive import LaneChangePredict
import numpy as np
...
def run(seed, episodes, batch_size, gamma, inverting_gradients, initial_memory_threshold, replay_memory_size,
    ...
    for i_eps in range(episodes):
        ...
        for i_step in range(max_steps):
            ...
            if i_eps == episodes - 1:
                ...
                df1.to_csv('result/aggressive/speedControl.csv', index=False, mode='a', header=False)
                df2.to_csv('result/aggressive/TTC.csv', index=False, mode='a', header=False)
    ...
    df.to_csv('result/aggressive/reward0820.csv', index=False, header=False)
...
if __name__ == '__main__':
    ...
    sumocfg_file = "normal/StraightRoad.sumocfg"
