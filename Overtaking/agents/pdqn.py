...
from Overtaking.agents.agent import Agent
from Overtaking.agents.memory.memory import NStepReplayBuffer, ReplayBuffer


# Neural network implementing state-action Q-function (Q-value)
...
# Learning parameters for continuous action spaces
class ParamActor(nn.Module):
    ...
    def __init__(self, state_size, action_size, action_parameter_size, hidden_layers=(256, 128, 64), activation="relu"):
        ...
        # Set this layer, weights and biases to non-trainable
...
class PDQNAgent(Agent):
    ...
    # Set the weight of the parameter transfer layer
    ...
    # Implemented the classic AC algorithm in reinforcement learning
    def _optimize_td_loss(self, epsilon=0.2, num_epochs=10):
        ...
        for _ in range(num_epochs):
            # Calculate the current log probability sum value
