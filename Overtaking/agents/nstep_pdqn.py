...
from Overtaking.agents.memory.memory import NStepReplayBuffer
from Overtaking.agents.pdqn import PDQNAgent
...
class PDQNNStepAgent(PDQNAgent):
    ...
    # Implement the optimization function of TD-loss
